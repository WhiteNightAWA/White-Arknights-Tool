        ...
        <v-container v-if="!table" class="AO justify-space-around">
            <div class="cCard"
              ...
              >
                ...
                <img class="refLogo" style="width: 2em; position: absolute; left: 2.5em; top: 0; z-index: 2" :src="`https://raw.githubusercontent.com/Aceship/AN-EN-Tags/master/img/ui/subclass/sub_${character_table[c]['subProfessionId']}_icon.png`" alt="subClassLogo">
                    ...
                    <div style="display: flex" class="justify-space-between">
                      <div style="display: flex;" class="justify-center">
                        ...
                        <div style="display: flex;" class="align-center">
                          ...
                          <img class="refLogo" :src="`https://raw.githubusercontent.com/Aceship/AN-EN-Tags/master/img/ui/subclass/sub_${character_table[c]['subProfessionId']}_icon.png`" alt="professionLogo" style="width: 3em; height: 3em">
